...
public class HelloWorldService {
  ...
  public interface AsyncIface {
    ...
    public void sayHello(String username, String test, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String sayHello(String username, String test) throws TException
    {
      send_sayHello(username, test);
      return recv_sayHello();
    }

    public void send_sayHello(String username, String test) throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sayHello(String username, String test, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      sayHello_call method_call = new sayHello_call(username, test, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String test;
      public sayHello_call(String username, String test, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sayHello<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sayHello_args> {
      ...
      public sayHello_result getResult(I iface, sayHello_args args) throws TException {
        sayHello_result result = new sayHello_result();
        result.success = iface.sayHello(args.username, args.test);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHello<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHello_args, String> {
      ...
      public void start(I iface, sayHello_args args, AsyncMethodCallback<String> resultHandler) throws TException {
        iface.sayHello(args.username, args.test,resultHandler);
      }
    }
  ...
  public static class sayHello_args implements org.apache.thrift.TBase<sayHello_args, sayHello_args._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_args>   {
    ...
    private static final org.apache.thrift.protocol.TField TEST_FIELD_DESC = new org.apache.thrift.protocol.TField("test", org.apache.thrift.protocol.TType.STRING, (short)2);
    ...
    public sayHello_args setTest(String test) {
      this.test = test;
      return this;
    }
